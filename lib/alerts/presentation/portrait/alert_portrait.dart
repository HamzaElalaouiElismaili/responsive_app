...
class AlertPortrait extends HookWidget {

  const AlertPortrait({Key? key}) : super(key: key);
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      [
                        ...
                        Spacer(),
                        GestureDetector(onTap: ()=>Navigator.pop(context), child: SvgPicture.asset(Assets.icons.back.path)),
                      ],
                    ),
                  ),
                ),
                      ...
                      [
                        ...
                        ElevatedButton(onPressed: ()
                        {
                          ...
                          Alert alert = Alert(
                            ...
                            location: !isRoom.value ? 'Room' : 'Equipment',
