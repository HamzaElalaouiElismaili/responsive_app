...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/obser.svg
  SvgGenImage get obser => const SvgGenImage('assets/icons/obser.svg');

  /// File path: assets/icons/observations.svg
  SvgGenImage get observations =>
      const SvgGenImage('assets/icons/observations.svg');
  ...
  /// File path: assets/icons/resolved.svg
  SvgGenImage get resolved => const SvgGenImage('assets/icons/resolved.svg');
  ...
  /// File path: assets/icons/subcategory.svg
  SvgGenImage get subcategory =>
      const SvgGenImage('assets/icons/subcategory.svg');

  /// File path: assets/icons/tags.svg
  SvgGenImage get tags => const SvgGenImage('assets/icons/tags.svg');
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [img, img1];
}
